...
public class CadutaUrano : MonoBehaviour
{
    ...
    public void StartCaduta()
    {
        ...
        sfera.gameObject.AddComponent<GravitaPersonalizzata>().Inizializza(gravitaUrano);
    }
