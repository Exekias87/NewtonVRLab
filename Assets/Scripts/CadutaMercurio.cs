...
public class CadutaMercurio : MonoBehaviour
{
    ...
    public void StartCaduta()
    {
        ...
        sfera.gameObject.AddComponent<GravitaPersonalizzata>().Inizializza(gravitaMercurio);
    }
