...
public class CadutaSaturno : MonoBehaviour
{
    ...
    public void StartCaduta()
    {
        ...
        sfera.gameObject.AddComponent<GravitaPersonalizzata>().Inizializza(gravitaSaturno);
    }
