...
public class CadutaVenere : MonoBehaviour
{
    ...
    public void StartCaduta()
    {
        ...
        sfera.gameObject.AddComponent<GravitaPersonalizzata>().Inizializza(gravitaVenere);
    }
