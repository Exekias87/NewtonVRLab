...
public class CadutaNettuno : MonoBehaviour
{
    ...
    public void StartCaduta()
    {
        ...
        sfera.gameObject.AddComponent<GravitaPersonalizzata>().Inizializza(gravitaNettuno);
    }
